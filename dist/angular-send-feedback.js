		...
		link: function ($scope) {
			...
			var settings = _.extend({
				...
				tpl: {
					...
					overview: '<div id="feedback-overview"><div class="feedback-logo">Feedback</div><div id="feedback-overview-description"><div id="feedback-overview-description-text"><h3>Subject</h3><h3>Description</h3></div></div><div class="feedback-buttons"><button id="feedback-submit" class="feedback-submit-btn feedback-btn-blue">Submit</button><button id="feedback-overview-back" class="feedback-back-btn feedback-btn-gray">Back</button></div><div id="feedback-overview-error">Please enter a description.</div><div class="feedback-wizard-close"></div></div>',
						...
						html2canvas($('body'), {
							onrendered: function (canvas) {
								...
								if (settings.showDescriptionModal) {
									...
									$('<textarea placeholder="Subject of feedback" id="feedback-overview-subject">' + '</textarea>').insertAfter('#feedback-overview-description-text h3:eq(0)');
									$('<textarea placeholder="Describe your problem in detail" id="feedback-overview-note">' + $('#feedback-note').val() + '</textarea>').insertAfter('#feedback-overview-description-text h3:eq(1)');
